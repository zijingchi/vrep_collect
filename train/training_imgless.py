...
def model_with_config_n_target():
    ...
    final = Dense(512, activation='relu', name='final_dense1')(merge2)
...
def train_with_generator(datapath, batch_size, epochs):
    ...
    h5file = '../train/h5files/model3_11.h5'
    model = load_model(h5file)

    """model.compile(loss='mse',
                  optimizer=optimizers.Adam(lr=2e-4, beta_1=0.9, beta_2=0.999, decay=0.2),
                  metrics=['mae'])"""
    ...
    model.fit_generator(generator=train_gen,
                        ...
                        callbacks=[TensorBoard(log_dir='./tensorboard_logs/model6/log')],
                        workers=2)
    model.save('./h5files/model6.h5')


if __name__ == '__main__':
    train_with_generator('/home/czj/vrep_path_dataset/4/', 64, 10)
