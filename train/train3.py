...
def fdlp4theta(dof):
    ...
    y = Dense(64, name='f-dense1',
              kernel_regularizer=regularizers.l1(l1_regu))(input)
...
def model_with_latentspace(dof):
    ...
    o = Dense(128, name='obs-latent-dense1',
              kernel_regularizer=regularizers.l1(l1_regu),
              bias_regularizer=regularizers.l2(l2_regu))(obstacle)
    ...
    t = Dense(64, name='target-obs-dense1',
              kernel_regularizer=regularizers.l1(l1_regu),
              bias_regularizer=regularizers.l2(l2_regu))(target)
    ...
    obs_all = Dense(100, activation='relu',
                    ...
                    kernel_regularizer=regularizers.l1(l1_regu),
                    bias_regularizer=regularizers.l2(l2_regu))(obs_all)
    ...
    final = Dense(128, activation='relu',
                  name='final-dense2',
                  kernel_regularizer=regularizers.l1(l1_regu),
                  bias_regularizer=regularizers.l2(l2_regu))(final)
...
def train_with_generator(datapath, batch_size, epochs):
    model = model_with_latentspace(5)
    ...
    plot_model(model, to_file='5dof_latent2.jpg', show_shapes=True)
    ...
    history = model.fit_generator(generator=train_gen,
                                  ...
                                  callbacks=[TensorBoard(log_dir='./tensorboard_logs/5dof_latent2/log')],
                                  workers=3)
    # K.clear_session()
    model.save('./h5files/5dof_latent_2.h5')
    model.save_weights('./h5files/5dof_latent_weights2.h5')


if __name__ == '__main__':
    datapath = '/home/czj/vrep_path_dataset/16/'
    #separate_train_test2(datapath, 'list1.pkl', 'list0.pkl')
    train_with_generator(datapath, 64, 500)
