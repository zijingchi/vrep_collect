...
def urfka1(theta1, d1):
    ...
    z = tf.constant(0.)
    #A1 = tf.zeros((4, 4))
    A1 = [[a1, a3, z, z], [a2, a1, z, z], [z, z, a5, a6], [z, z, z, a5]]
...
def urfka2(theta2, d2):
    ...
    c6 = tf.constant(1.)
    z = tf.constant(0.)
    A2 = [[c1, c3, z, z], [z, z, c4, c5], [c2, c1, z, z], [z, z, z, c6]]
...
def urfka3(theta3, a):
    ...
    a6 = tf.constant(a)
    z = tf.constant(0.)
    A3 = [[a1, a3, z, a6], [a2, a1, z, z], [z, z, a5, z], [z, z, z, 1.]]
...
def urfka4(theta4, a):
    ...
    a6 = tf.constant(a)
    z = tf.constant(0.)
    A4 = [[a1, a3, z, a6], [a2, a1, z, z], [z, z, a5, z], [z, z, z, a5]]
...
def urfka5(theta5, d5):
    ...
    a7 = tf.constant(1.0)
    z = tf.constant(0.)
    A5 = [[a1, a2, z, z], [z, z, a5, a6], [a3, a1, z, z], [z, z, z, a7]]
...
def main():
    ...
    for A in All:
        A0 = A0 @ A
    print(A0[:3, 3])"""
    #thetas = tf.placeholder(tf.float32, shape=(1, 5), name='theta')
