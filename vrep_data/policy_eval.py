...
from vrep_data.vrep_with_policy1 import UR5WithCameraSample
import numpy as np

pi = np.pi


class PolicyEval(UR5WithCameraSample):
...
def main():
    ...
    workpath = homepath + '/vrep_path_dataset/eval1/'
    path1 = path0[:path0.rfind('/')]
    model_path = os.path.join(path1, 'train/h5files/model10_14_weights.h5')
